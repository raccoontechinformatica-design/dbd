...
<body>
    <div class="icon">
        <div class="flexible">
             <!-- <button type="button" onclick="randomKiller()" title="Sortear killer">
                <img src="assets/dice-gambling-game-svgrepo-com.svg" alt="" width="25px" height="25px">
            </button> -->
            <button type="button" id="toggleWallpaper" title="Mostrar/ocultar fundo">
